...
const submitApplication = () => {
  ...
  http.$post('/itemIssuance', payload)
      ...
      .catch((error) => {
        ...
        } else if (error.response?.data?.code === 'EXCEED_THE_ANNUAL_LIMIT_FOR_RECEIPT') {
          ElMessage.error('超出年度领取限额')
        } else {
...
<template>
  <div class="page-container">
      ...
      <div class="table-section">
        ...
        >
          ...
          <el-table-column v-if="!currentUser.isAdmin" label="操作" align="center" class-name="uniform-column" width="180">
            <template #default="{ row }">
              <el-button  type="danger" size="small" @click="request(row.id)">
                申请
              </el-button>
            </template>
          </el-table-column>
    ...
    <el-dialog v-model="editDialogVisible" title="编辑物品" width="600px" center>
      <el-dialog v-model="applyDialogVisible" title="物品申请" width="500px" center>
